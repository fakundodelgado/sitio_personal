...
<div class="row">
        <main class="col-12 col-s-9">
            <div class="row">
                <div class="col-12 col-s-12">
                    <h1>Sobre mí</h1>
                </div>
            
                <section id="personal" class="col-12 col-s-12">

                    <h2>Quién soy:</h2>

                    <div class="row">
                        <div class="col-12 col-s-12 contenedor-imagen">
                            <img src="recursos/imagenes/Don Ramon.jpg" alt="Foto con Don Ramon" class="img-tarjeta">
                        </div>
                        <div class="col-12 col-s-12">
                            <p> 
                ...
                <section id="vocacion" class="col-12 col-s-12">
                    <h2>¿Por qué elegí la programación?</h2>
                    <div class="row">
                        <div class="col-12 col-s-12 contenedor-imagen">
                            <img src="recursos/imagenes/programando.gif" alt="Programando" class="img-tarjeta">
                        </div>
                        <div class="col-12 col-s-12">
                            <p> 
